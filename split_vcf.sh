...
bcftools view _local/1000G/ALL.chr17.shapeit2_integrated_snvindels_v2a_27022019.GRCh38.phased.HG00096.vcf.gz | wc -l

bcftools view --min-ac=1 _local/1000G/ALL.chr17.shapeit2_integrated_snvindels_v2a_27022019.GRCh38.phased.HG00096.vcf.gz | wc -l